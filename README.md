...
# Домашняя работа - Применение системы логирования в инфраструктуре на основе Docker

Работа с различными системами логирования

# Домашняя работа - Введение в Kubernetes

Развертывание kubernetes с помощью The Hard Way
